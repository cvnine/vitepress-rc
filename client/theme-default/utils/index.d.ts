 ...
 */
export declare function getSideBarConfig(sidebar: DefaultTheme.SideBarConfig | DefaultTheme.MultiSideBarConfig, relativePath: string): DefaultTheme.SideBarConfig;
/**
...
export declare function resolveLink(base: string, path?: string): string | undefined;
